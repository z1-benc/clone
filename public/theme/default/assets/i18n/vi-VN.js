window.settings.i18n['vi-VN'] = {
  ...
  '该订阅长期有效': 'Gói này có thời hạn dài',
  '已过期': 'Tài khoản hết hạn',
  '已用 {used} / 总计 {total}': 'Đã sử dụng {used} / {total} Dung lượng',
  '在线设备 {alive_ip}/{device_limit}': 'Online {alive_ip} / {device_limit} Thiết bị',
  'Email: {email}': 'Email: {email}',
  'ID định danh: {iduser}': 'ID định danh: {iduser}',
  'SNI user: {name_sni}': 'SNI user: {name_sni}',
  '重置订阅信息': 'Reset thông tin gói',
