...
<head>
    ...
    <meta name="description" content="Xác minh email - {{$name}}">
    <title>Xác minh email - {{$name}}</title>
</head>
        ...
        <tr><td align="center">
            <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
                ...
                <tr><td style="background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);border-radius:16px 16px 0 0;padding:32px 40px;text-align:center;">
                    <h1 style="color:#fff;font-size:20px;font-weight:600;margin:0 0 4px;">🔐 Xác Minh Email</h1>
                ...
                <tr><td style="background:#fff;padding:36px 40px;">
                    ...
                    <p style="font-size:14px;color:#4a5568;margin:0 0 24px;line-height:1.6;">Vui lòng sử dụng mã xác nhận bên dưới để hoàn tất xác minh email. Mã có hiệu lực trong <strong>5 phút</strong>.</p>
                    <!-- Code Box -->
                    ...
                    <p style="font-size:12px;color:#a0aec0;margin:0 0 28px;text-align:center;">⚠️ Không chia sẻ mã này cho bất kỳ ai</p>
                    <!-- CTA Button -->
